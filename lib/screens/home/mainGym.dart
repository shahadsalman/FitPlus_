                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                          '${AppController.to.loginMap['workingHours'][index]['name']} ${AppController.to.loginMap['workingHours'][index]['Time']}')),
                                );
                              },
                            ),
                          ),
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                Map<String, dynamic> data =
                                    AppController.to.loginMap['price'];

                                var sortedKeys = AppController
                                    .to.loginMap['price'].keys
                                    .toList()
                                  ..sort((a, b) =>
                          ...
                          children: [
                            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                              stream: FbFireStoreController()
                                  .getGymsReviewStream(gymId: gymData["gymId"]),
                              builder: (context, snapshot) {
                                ...
                                if (snapshot.hasData && snapshot.data != null) {
                                  for (var element in snapshot.data!.docs) {
                                    reviews.add(
                                        ReviewModel.fromJson(element.data()));
                                  }
                                  reviews.sort((a, b) =>
