...
class OfferDialog extends StatefulWidget {
  ...
  final bool isUpdate;
   ...
   const OfferDialog(
      {super.key, this.nameController, this.priceController, this.onTap, this.children, this.isUpdate = false, this.selectedPlan});
          ...
          child: Column(
            ...
            children: [
              ...
              const Row(
                children: [
                  SizedBox(width: 20),
                  Text("Please select the month",style: TextStyle(color: Colors.red),),
                ],
              ),
              const SizedBox(height: 15),
              Padding(
              ...
              Padding(
                ...
                child: TextFormField(
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Please enter offers’ price';
                    }
                    return null;
                  },
